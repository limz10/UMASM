...
/* Like most assemblers, the UM assembler combines “create new section” and 
 “switch to existing section” in a single operation. If the named section is 
 not already part of the assembler, this operation creates a new section and
 appends it to the assembler’s sequence of sections. The named section is
 then made the current section. */
